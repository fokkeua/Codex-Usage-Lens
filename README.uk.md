...
Увімкніть **«Налаштування → Дані → Застосунок → Відкривати під час входу в
macOS»**, щоб Codex Usage Lens з’являвся в рядку меню після входу в обліковий
запис. Застосунок використовує штатний механізм «Об’єкти входу» й за потреби
відкриває відповідний розділ системних налаштувань.

Це також рекомендований варіант для спільної роботи з Codex: на момент запуску
Codex лінза вже працює. macOS не надає сторонньому застосунку подію запуску
Codex без окремого постійно активного helper-процесу, тому застосунок не
встановлює такий watcher.
